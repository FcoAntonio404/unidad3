			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						document.getElementById("txtResultado"+i).style="border:solid green; background-color:green;";
					}
						
					else
						//mostra fondo incorrecta en el input text cuan es correcta la respuestas
						document.getElementById("txtResultado"+i).style="border:solid red; background-color:red;";
